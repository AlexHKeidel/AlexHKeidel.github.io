...
...More like bleeps and bloops from data. (Year 4)

## MyMedicare (Android App)
[Github repo](https://github.com/AlexHKeidel/MyMedicare)
...
Year 2 (Code not yet uploaded)

## FUNctional Programming (Clojure)
Year 4 (Code not yet uploaded)

## First website (HTML/CSS/JS)
[Github repo missing]()
First coursework involving a simple HTML website (1st year)
...
[Private Github, request access if desired](https://github.com/cnicholas63/InterfaceMockup)
A group project augmented reality mobile app utilising QR-code markers to provide an augmented reality overview of the Edge Hill University Tech Hub building with interactive information. (Year 4)
